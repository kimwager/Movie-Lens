...
The different optimal lambda values for the two models reflect how the addition of genre effects changes the optimal regularization strength needed to prevent overfitting. The final model with genre effects typically requires a different lambda value because it has an additional set of parameters (genre effects) that also need to be regularized.
