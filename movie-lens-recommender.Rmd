...
The regularized model with genre effects has negligible effect on the performance with an RMSE of 0.8649. This means that the movie effects may already implicitly capture the genre effects. 