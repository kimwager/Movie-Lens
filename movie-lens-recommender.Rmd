...
This baseline model makes the same prediction (the overall average rating) for every movie, regardless of the specific movie or user. While this is obviously not very sophisticated, it gives us:
...
The key insight from this model is that we get an RMSE of, 1.06, this means our predictions are off by about 1.06 stars on average.