...
The regularized model with genre effects has negligible effect on the performance with an RMSE of 0.8649. This means that the movie effects may already implicitly capture the genre effects. I alos note that the genres are grouped, which means that the effects of a single genre may be diluted. 

Now I will test the final model on the holdout dataset.
...
# Optional: Compare predicted vs actual ratings distribution
library(ggplot2)
